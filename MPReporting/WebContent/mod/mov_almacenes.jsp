...
<div id="rightnow">
    <h3 class="reallynow">
        <span>Movimiento De Almacenes</span>
...
<div id="box">
	<h3>Movimiento De Almacenes</h3>
	<iframe style="width:940px" height="400px" frameborder="0"  src="mod/charts/ic_mov_almacenes.jsp" class="pptosP" id="a_ventas"></iframe>
</div>
</body>
</html>