...
System.out.println("Nombre "+nomValue);
response.setContentType ("application/vnd.ms-excel"); //Tipo de fichero.
response.setHeader ("Content-Disposition", "attachment;filename=\""+nomValue+".xls\"");
%>
<%
...
if(chart_id.equals("10")){
	...
	System.out.println("user "+id_user+ " modulo "+id_modulo +"id_chatr "+idF+"mediad "+medida);
	var = pptos.getTablePptosGnrl("1", id_user, id_modulo, "1", idF, "medida", "2013", "2013",medida, "id", "asc", true,false,true);
