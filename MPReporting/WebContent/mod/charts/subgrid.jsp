...
<div id="box">
	<h3><%=nomValue %></h3>
<%=var %>
<a href="excel_gnrl.jsp?delFil=true&user=<%=id_user %>&mod=<%=id_modulo %>&chart_id=<%=chart_id %>&medida=<%=medida %>&nomVal=<%=nomValue %>" target="_blank"><img src="../../img/xls.jpg" width="25" height="25"/></a>
</div>