	...
	private function drawHeaders (){
		...
		if (this.params.caption != ""){
			...
			if (this.params.animation){
				this.styleM.applyAnimation (captionObj.tf, this.objects.CAPTION, this.macro, this.elements.canvas.x + (this.elements.canvas.w / 2) - (this.elements.caption.w / 2) , this.params.chartTopMargin, 100, null, null, null);
			}
			//Apply filters
		...
		if (this.params.subCaption != ""){
			...
			//Apply animation
			if (this.params.animation){
				this.styleM.applyAnimation (subCaptionObj.tf, this.objects.SUBCAPTION, this.macro, this.elements.canvas.x + (this.elements.canvas.w / 2) - (this.elements.subCaption.w / 2) , this.elements.canvas.y - this.params.captionPadding - this.elements.subCaption.h, 100, null, null, null);
			}
			//Apply filters
