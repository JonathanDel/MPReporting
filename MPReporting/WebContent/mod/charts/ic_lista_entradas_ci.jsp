...
System.out.println("ID_INSUM_COMP "+id_comp_insum);
...
if(id_comp_insum != null ){
	prod_no_desplaza = inv.getTableListaEntradasInsComp("1",id_user, id_modulo, "1", "3", id_comp_insum, fechaIni, fechaFin, id_espacios);
}
%>
<%=prod_no_desplaza %>
