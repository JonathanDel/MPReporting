...
<form action="excel.jsp" method="POST" onsubmit="return cadenaTabla()">
 ...
 <!--  <a href="excel_princ_indicadores.jsp" target="_blank"><img src="../../img/xls.jpg" width="25" height="25"/></a> -->
 <!--   <a href="excel-inventarios-compras.jsp?char_id=4&id_user=<%=id_user  %>&id_modulo=<%=id_modulo%>&mes=<%=mes%>" target="_blank"><img src="../../img/xls.jpg" width="25" height="25" /></a>--> 
</body>
</html>