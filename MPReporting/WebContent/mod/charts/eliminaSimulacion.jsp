...
if(id_user != null && id_dashboard != null 
){
	System.out.println("usr: "+id_user+" dash: "+id_dashboard+" portlet: "+id_portlet);
	inv.eliminaDatosSim(id_customer, id_user, id_modulo, id_dashboard, id_portlet, id_producto, diasP1, diasP2, diasP3, cajasP1, cajasP2, cajasP3);
}
