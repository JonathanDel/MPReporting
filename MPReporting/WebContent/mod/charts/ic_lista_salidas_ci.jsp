...
String id_comp_insum = request.getParameter("id_comp_insum");

String fechaIni = request.getParameter("fechaIni");
String fechaFin = request.getParameter("fechaFin");
//String idEspacios = request.getParameter("idEspacios");

System.out.println("ID_PROD_TERM "+id_comp_insum);
...
System.out.println("Lista entradas por lugar..."+ id_comp_insum);
String prod_no_desplaza = "";
if(id_comp_insum != null ){
	prod_no_desplaza = inv.getTableListaSalidasInsComp("1",id_user, id_modulo, "1", "3", id_comp_insum, fechaIni, fechaFin, id_espacios);
}
%>
<%=prod_no_desplaza %>
