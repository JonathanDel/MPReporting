...
function exportTableHTMLtoExcel(file_name){
	   ...
	   //var tbl_rpz = tbl.replace(' ','+');
	   //var table = encodeURIComponent( tbl_rpz);
	   //var table = encodeURIComponent( unescape($("#tblDatos").eq(0).clone().html()));
...
<%
String var = ""; 
var = pptos.getTablePptos("1", id_user, id_modulo, "1", "8", "medida", "2014", "2014",medida, "id", "asc", true, true);
%>
<%=var %>
